...
const money=n=>`GBP ${new Intl.NumberFormat("en-GB",{maximumFractionDigits:0}).format(Math.round(n||0))}`;
...
function refreshDashboard(){
  ...
  document.getElementById("adminCash").textContent=s?money(s.cash):"GBP 0";
